...
import Text.Megaparsec ( Parsec, try, notFollowedBy, between, eof, (<|>), many, sepBy1, parse, errorBundlePretty )
...
joinStmt   = Join <$ joinLex <*> aExp <* semicolon
haltStmt   = Halt <$  haltLex <* semicolon
